...
2. Start the RPC services in the first terminal
3. Start client in the second terminal


Notes
/-----------------------------------------/
-Format for the database intialization files are as follows
...
-Assumptions
	-The current balance of the account is the current balance of the last entry
		-This means that this program does not try to calculate what it should be based on the intialization data
